...
db.acl.insertMany([
  ...
  {
    seq: 11,
    match: { labels: { group: "admin" } },
    actions: ["*"],
    comment: "Admin group members have full access to everything",
  },
  {
    seq: 20,
    ...
    actions: ["*"],
    comment:
      'User "test" has full access to test-* images but nothing else. (1)',
  },
  {
    seq: 30,
    match: { account: "test" },
    actions: [],
    comment:
      'User "test" has full access to test-* images but nothing else. (2)',
  },
  {
    seq: 40,
  ...
  },
  {
    ...
    actions: ["push", "pull"],
    comment:
      "Users can pull and push to the shared namespace of any group they are in",
  },
  {
    seq: 60,
    ...
    actions: ["push", "pull"],
    comment:
      "Users can pull and push to to namespaces matching projects they are assigned to",
  },
  {
    seq: 70,
    match: { account: "/.+/" },
